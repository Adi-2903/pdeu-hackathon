...
import { getIngestionLogs } from "@/frontend/lib/db/queries";
...
export default function IngestionPage() {
  ...
  const fetchLogs = async () => {
    ...
    setLogs(data.slice((page - 1) * 10, page * 10));
  };
    ...
    try {
      ...
      switch (sourceType) {
        case "gmail":
          ...
          break;
        case "indeed":
          url = "/api/ingest-indeed";
          break;
        case "linkedin":
          url = "/api/ingest-linkedin";
          break;
        case "merge_ats":
          url = "/api/ingest-ats?source=merge";
          break;
        case "zoho":
          url = "/api/ingest-ats?source=zoho";
          break;
        default:
