  ...
  const fetchCandidates = async () => {
    ...
    try {
      ...
      if (selectedSource !== "all") {
        // Filter by any source in the sources[] array
        query = query.contains("sources", [selectedSource as any]);
      }
      ...
      if (isMergedOnly) {
        // Candidates with more than one source are considered "merged"
        query = query.not("sources", "is", null);
      }
